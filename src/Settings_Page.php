...
class Settings_Page {
	...
	public function add_options_page() {
		...
		$menu_page_args = [
			__( $this->page_title, 'nicabm-utility-plugin' ),
			__( $this->menu_title, 'nicabm-utility-plugin' ),
			$this->capability,
			$this->menu_slug,
	...
	public function add_options_page_metabox() {
		...
		foreach ( $this->metabox_fields as $field ) {
			if ( ! empty( $field['name'] ) ) {
				$field['name'] = __( $field['name'], 'nicabm-utility-plugin' );
			}

			if ( ! empty( $field['desc'] ) ) {
				$field['desc'] = __( $field['desc'], 'nicabm-utility-plugin' );
			}
	...
	public function settings_notices( $object_id, $updated ) {
		...
		add_settings_error(
			...
			'',
			__( 'Settings updated.', 'nicabm-utility-plugin' ),
			'updated'
		);
