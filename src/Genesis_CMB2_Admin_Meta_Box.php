...
abstract class Genesis_CMB2_Admin_Meta_Box extends Post_Metabox {
	...
	public function init_metabox() {
		$overrides = [
			'title'        => __( $this->metabox_config['title'], 'nicabm-utility-plugin' ),
		...
		foreach ( (array) $this->fields_config as $field_config ) {
			$field_config['name'] = __( $field_config['name'], 'nicabm-utility-plugin' );
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'genesis-cmb2-admin-styles', NICABM_UTILITY_URL . '/assets/css/genesis-cmb2-admin-styles.css', [], '0.1.0' );
	}
}
